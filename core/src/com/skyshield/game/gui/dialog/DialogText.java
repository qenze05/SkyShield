        ...
        switch (textCounter) {
            case 1 -> {
                return "Алло, алло, прийом. Фух, нарешті вийшло зв’язатися з тобою, салаго. На рації генерал Аскель, головнокомандувач військових сил Етерії. Хоча, навіщо я це кажу, ти ж і так знаєш, як звуть начальство? Проїхали. В буремні часи живемо, салаго… Одначе, місія тобі довірена справді надважлива. Ти навіть не уявляєш яка важлива.\n" +
                        ...
                        "Радіус – це відповідно радіус круга, який покривається установкою.\n" +
            ...
            case 3 -> {
                return "ЧОРТ! Ціль досягла міста! О рідний мій Монфіор! Вони заплатять за це, чуєш! Будь проклятий Карам-Гулук!\n" +
                        "Салаго… Тобі доведеться трохи приглянути за містом. Обери його та оформи ремонт. Формула визначення ціни скоро стане очевидною. Удачі.\n";
            }
            case 4 -> {
                return "Молодець. Моє місто житиме. Продовжуй в тому ж дусі, друже.";
            }
            case 5 -> {
                return "Друже… Маю погані новини. Схоже, що ці мерзоти зрозуміли, що ми пристосувалися до їх атак, тому вирішили під накопичити пташок для серйозної атаки. Поки що я не знаю, як наші системи впораються з таким навантаженням, проте я вибив із уряду додаткові 20000 злотих. Цього тобі вистачить аж на 40 перших «Крон». Ну або на 4 треті. Розпоряжайся, як знаєш. Удачі, бійцю.";
            }
            case 6 -> {
                return "Мені зозуля на хвості принесла, що ти відбив атаку? Не сумнівався в тобі, салаго. Так ти скоро і на підвищення підеш. Проте не розслабляйся, попереду ще довга війна. І вони ще застосують багато нового озброєння та нових тактик, повір.";
            }
            case 7 -> {
                return "Друже… Маю погані новини. Знову. Вони знову накопичили багато зброї. І, якщо мої джерела достовірні, вони готують новий вид зброї. Кріпись, салаго. Від тебе багато залежить.";
            }
            case 8 -> {
                return "Чудово. Ми пережили атаку. А зараз відбій.\n" +
                        "Чудові новини з фронту. Завдяки поставкам. вдалося трохи відсунути натиск загарбників. Якщо все йтиме за планом, скоро будемо намагатися взяти Форт-Ост. Зробити це буде складно, ординці звикли до рівнинної місцевості. Проте я вірю в наших. Тим більше, їх тил прикриває такий спец, як ти.\n" +
                        "Ще одні чудові новини. Партнери поставили нові плюшки, а, якщо бути точним, дві нові установки. «Слон» - потужна, але досить повільна. «Скорпіон» - швидка, проте б’є точково. Детальніші характеристики почитай сам. Удачі, салаго.\n";
            }
            case 9 -> {
                return "Що ж, ці обстріли вже потроху стають нормою. Готуйся, на підході гаряча доба. Я вірю, салаго, я вірю…";
            }
            case 10 -> {
                return "Феєрично, капітане, феєрично. Вони ще заплатять за все. Точніше, вже почали платити.\n" +
                        "Наші військові зайшли у Форт-Ост. Інформація достовірна. Ох, зараз їм буде непереливки.\n" +
                        "Щоправда, є і невтішна інформація. Тенебрійці отримали партію нового озброєння – дрібних пташок, яких вони називають «мухами». Проте ми оперативно замовили у партнерів установки для збиття дрібних цілей. Я вірю в тебе. Удачі. \n";
            }
            case 11 -> {
                return "Час масованої атаки. Ще 75000 від командування. Працюй.";
            }
            case 12 -> {
                return "Нашу країну не підкорять ні Коршуни, ні Мухи, ні будь що інше. Нашими військами було звільнено Гладіополіс – місто воїнів. Рухаємось до кордону семимильним кроками.\n" +
                        "А тим часом повітряний простір потрібно захищати. Бо битви перемгаюаться на землі, а от війни – у небі.\n" +
                        "Розвідка повідомила, що наступна загроза може піти з води. Під ударом опиняться Порт-Лазурі та Акватіс. Ех, зараз би на пляжик… Після війни обов’язково з’їздемо туди. Ех, золоті піски Кастилії…\n";
            }
            case 13 -> {
            ...
            case 14 -> {
                return "ЄС! Атаку відбито! Я не мав жодного сумніву, що ти впораєшся. Як не мав жодного сумніву і в своїх бравих воїнах, яким тільки що вдалося звільнити Президіум – те саме місто, під яким дві сотні років тому була розбита Болотна Орда. «Можем павтаріть» - казали вони. Що, ж, повторимо, паскуди. Тільки треба трохи дотиснути.\n" +
                        "Але покидьки не стоять на місці. Розвідка повідомляє, що наступного тижня вони готові застосувати одразу ТРИ ноу-хау: гіперзвукову ракету «Сапсан», магнітний дрон «Електра» та ракету «Сновида». З першою боротися досить складно, проте ніяких особливих прийомів в неї немає – просто дуже швидка та смертоносна ракета. «Електри» - винахід дуже підступний. Це маленькі мухи, пристосовані спеціально для удару по етеростанціям. При влучанні вони вноситимуть дисбаланс у всю систему, тож запасайся «Пульсарами» – знадобляться. «Сновида» - це зовсім дика штука. Цей залізний птах невидимий для звичайних радарів. Для того, щоб його виявити і зробити придатним для збиття, необхідно застосувати спеціальний радар «Око Гора». Його нам теж передали партнери в трьох комплектаціях. Сподіваюсь, ти розберешся. Кажу, як казав завжди: удачі, салаго!\n";
            }
            case 15 -> {
                return "Салаго, оперативна інформація. У ординців новий підступний план. Вони вирішили позбавити країну енергії – вивести з ладу етеростанції. Дуже важливо не допустити катастрофи. Якщо хоч одна станція повністю зупиниться – це заморозить регіон до її відновлення. А запускати станцію з нуля втричі дорожче, ніж просто відремонтувати. А якщо, не дай Бог, вся країна позбавиться етеру і війде в повний блекаут… Можливо, це кінець. Тримай небо, салаго. Темряві не перемогти світло! Удачі.";
            }
            case 16 -> {
