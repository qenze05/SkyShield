...
public class Slon extends AirDef{
    ...
    public Slon(float[] pos) {
        ...
        this.reload = 3;
        this.radius = 300;
        this.centrality = 0.8f;
        this.price = 7500;
        this.lastLaunchTime = 0;
        this.texture = new Texture(Gdx.files.internal("air-defence/Slon.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Slon-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Slon.png"));
    }
