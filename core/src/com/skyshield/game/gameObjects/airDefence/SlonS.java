...
public class SlonS extends AirDef{
    ...
    public SlonS(float[] pos) {
        ...
        this.texture = new Texture(Gdx.files.internal("air-defence/Slon-S.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Slon-S-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Slon-S.png"));
    }
