...
public class KronaMK1 extends AirDef{
    ...
    public KronaMK1(float[] pos) {
        super(pos);
        this.pos = pos;
        this.name = "Krona-MK1";
        this.optimalSpeed = 1000;
        this.optimalSize = 7;
        this.reload = 2;
        this.radius = 50;
        ...
        this.texture = new Texture(Gdx.files.internal("air-defence/Krona-MK1.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Krona-MK1-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Krona-MK1.png"));
    }
