...
public class Mukhobiyka extends AirDef{
    ...
    public Mukhobiyka(float[] pos) {
        super(pos);
        this.pos = pos;
        this.name = "Mukhobiyka";
        ...
        this.texture = new Texture(Gdx.files.internal("air-defence/Mukhobiyka.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Mukhobiyka-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Mukhobiyka.png"));
    }
