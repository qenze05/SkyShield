...
public class PulsarS extends AirDef{
    ...
    public PulsarS(float[] pos) {
        super(pos);
        this.pos = pos;
        this.name = "Pulsar-S";
        this.optimalSpeed = 500;
        this.optimalSize = 1;
        this.reload = 0.33f;
        this.radius = 300;
        this.centrality = 0.75f;
        this.price = 40000;
        this.lastLaunchTime = 0;
        this.texture = new Texture(Gdx.files.internal("air-defence/Pulsar-S.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Pulsar-S-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Pulsar-S.png"));
    }
