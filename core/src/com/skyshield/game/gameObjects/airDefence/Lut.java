...
public class Lut extends AirDef{
    ...
    public Lut(float[] pos) {
        ...
        this.texture = new Texture(Gdx.files.internal("air-defence/Lut.png"));
    ...
    public void setTexture() {
        this.texture = locked
                ? new Texture(Gdx.files.internal("air-defence/Lut-locked.png"))
                : new Texture(Gdx.files.internal("air-defence/Lut.png"));
    }
